...
class ChatRoom(models.Model):
    ...
    class Meta:
        ...
        # Prevent duplicate 1–1 chat rooms
        unique_together = ('participant_1', 'participant_2')

    def save(self, *args, **kwargs):
        """
        Ensure participant_1 < participant_2 to enforce uniqueness in PostgreSQL.
        This prevents duplicate rooms like (A,B) and (B,A).
        """
...
class Message(models.Model):
    ...
    # Better for PostgreSQL & API payloads
